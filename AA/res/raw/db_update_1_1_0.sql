...
[配伍]  配肾俞、志室、大赫、关元、命门治阳萎、遗精（肾气虚型） ；配膀胱俞、肾俞、次豂、阴陵泉、蠡沟治阳萎、遗精、癃闭、淋症、阴痒、湿疹、带下（湿热下注） ；配中极、关元、肾俞治肾虚、遗尿、小便不利；配关元、命门、阴交（针' where CODE = 'CV2';
update ACUPOINT set DESCRIPTION_ZH = '<<针灸学>>@TCM100.COM: 
[定位]  在下腹部，前正中线上，当脐下4寸。
[解剖]  在腹白线上，深部为乙状结肠；有腹壁浅动、静脉分支，腹壁下动、静脉分支；布有髂腹下神经的前皮支。
[主治]  小便不利，遗溺不禁，阳痿，遗精，疝气，月经不调，带下，崩漏，阴挺。
[操作]  直刺0.5~1.5寸。
[配伍]  配大赫、肾俞、阴交、三阴交、次豂治阳萎、早泄、遗精、白浊、月经不调、痛经崩漏、产后恶露不止、胞衣不下、阴挺等症（肾气虚型） ；配阴谷、气海、肾俞治遗溺不止；配大敦、关元、三阴交治疝气偏坠；配水分、三焦俞、三阴交、气海、委阳治水' where CODE = 'CV3';
update ACUPOINT set DESCRIPTION_ZH = '<<针灸学>>@TCM100.COM: 
[定位]  在下腹部，前正中线上，当脐下3寸。
[解剖]  在腹白线上，深部为小肠；有腹壁浅动、静脉分支，腹壁下动、静脉分支；布有第十二肋间神经前皮支的内侧皮支。
[主治]  遗尿，小便不利，疝气，遗精，阳萎，月经不调，崩漏带下，阴挺，不孕。
[操作]  直刺0.5~2寸；可灸。
[配伍]  配气海、肾俞（重灸） 、神阙（隔盐灸） 急救中风脱证；配足三里、脾俞、公孙、大肠俞治虚劳、里急、腹痛；配三阴交、血海、中极、阴交治月经不调（冲任不固，针用补法） ；配中极、大赫、肾俞、次豂、命门、三阴交治男子不育症、' where CODE = 'CV4';
update ACUPOINT set DESCRIPTION_ZH = '<<针灸学>>@TCM100.COM: 
[定位]  在下腹部，前正中线上，当脐下2寸。
...
[操作]  直刺0.5~2寸。
[配伍]  配三阴交治白浊、遗精；配关元治产后恶露不止；配灸关元、膏肓、足三里治喘息短气（元气虚惫）；配关元、命门（重灸）、神阙（隔盐灸）急救中风脱证。配足三里、脾俞、胃俞、天枢、上巨虚治胃腹胀痛、呃逆、' where CODE = 'CV6';
update ACUPOINT set DESCRIPTION_ZH = '<<针灸学>>@TCM100.COM: 
[定位]  在下腹部，前正中线上，当脐下1寸。
...
[操作]  直刺0.5~1.5寸。
[配伍]  配百会、足三里、神门治失眠、脏躁；配膻中、天突、丰隆治哮喘；配梁丘、下巨虚治急性胃肠炎；配肝俞、太冲、三阴交、公孙治疗胃十二指肠球部溃疡；配上脘、梁门（电针20分钟） 治胆道蛔虫症；配阳池、胞门、子户（针灸并用） ，治腰痛、痛经、月经不调（子宫不正） ；配气海、足' where CODE = 'CV12';
update ACUPOINT set DESCRIPTION_ZH = '<<针灸学>>@TCM100.COM: 
[定位]  在上腹部，前正中线上，当脐上5寸。
...
[配伍]  配定喘穴、鱼际治哮喘、咳嗽；配膻中、列缺治外感咳嗽；配内关、中脘治呃逆；配廉泉、涌泉治暴喑；' where CODE = 'CV22';
update ACUPOINT set DESCRIPTION_ZH = '<<针灸学>>@TCM100.COM: 
